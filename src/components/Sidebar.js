...
export function Sidebar({ isOpen, onClose, className }) {
  ...
  return (
    <aside className={`relative w-72 px-3 pt-20 h-full min-h-screen bg-zinc-50 overflow-auto text-zinc-900 shadow-lg shadow-slate-300 relative ${className}`} style={drawerStyle}>
