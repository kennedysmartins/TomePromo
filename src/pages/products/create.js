...
const CreateProducts = () => {
  ...
  const resetFormFields = () => {
    setProduct({
      ...
      announcement1: "🟢 Entre em nosso grupo de ofertas do WhatsApp: https://tomepromo.com.br/g",
      announcement2:
  ...
  const resetFormFieldsSearch = (link) => {
    setProduct({
      ...
      conditionPayment: "",
      sponsorLink: "https://amzn.to/47ilPBf",
      announcement1: "🟢 Entre em nosso grupo de ofertas: https://tomepromo.com.br/g",
      announcement2:
        "⚠️ O link ou foto da promo não apareceu? Só adicionar o número do administrador",
    });
  };
